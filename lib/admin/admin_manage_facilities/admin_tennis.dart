...
class FacilitiesAdminDetailsTenWidget extends StatefulWidget {
  const FacilitiesAdminDetailsTenWidget({Key? key}) : super(key: key);

  @override
  _FacilitiesAdminDetailsTenWidgetState createState() =>
      _FacilitiesAdminDetailsTenWidgetState();
}

class _FacilitiesAdminDetailsTenWidgetState
    extends State<FacilitiesAdminDetailsTenWidget> {
