...
class FacilitiesAdminDetailsBadWidget extends StatefulWidget {
  const FacilitiesAdminDetailsBadWidget({Key? key}) : super(key: key);

  @override
  _FacilitiesAdminDetailsBadWidgetState createState() =>
      _FacilitiesAdminDetailsBadWidgetState();
}

class _FacilitiesAdminDetailsBadWidgetState
    extends State<FacilitiesAdminDetailsBadWidget> {
