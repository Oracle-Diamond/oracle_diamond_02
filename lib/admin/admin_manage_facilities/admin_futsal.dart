...
class FacilitiesAdminDetailsFutsalWidget extends StatefulWidget {
  const FacilitiesAdminDetailsFutsalWidget({Key? key}) : super(key: key);

  @override
  _FacilitiesAdminDetailsFutsalWidgetState createState() =>
      _FacilitiesAdminDetailsFutsalWidgetState();
}

class _FacilitiesAdminDetailsFutsalWidgetState
    extends State<FacilitiesAdminDetailsFutsalWidget> {
